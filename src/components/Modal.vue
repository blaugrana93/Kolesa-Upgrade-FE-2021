        ...
        <div class="modal modal-bg__modal">
          ...
          <div class="main-info">
            <div class="main-info-header">
              ...
              <span class="main-info-price-text"
                >{{ this.card.price }} баллов</span
              >
            ...
            <div class="main-info-body">
              ...
              <div class="footer-block">
                ...
                <div class="footer-block-additional-info">
                  ...
                  >
                  <span class="footer-block-add-second"
          ...
          <input
            type="image"
            src="./assets/modal-close-pic.jpg"
            class="modal-close"
            @click="closeModal"
          />
        </div>
...
export default {
  ...
  methods: {
    ...
    orderInModal() {
      this.$emit("orderFromModal", this.card.price);
    },
    getFormattedFirstImage(mainImg, defaultImg) {
      return mainImg && mainImg.length ? `${mainImg[0]}` : `${defaultImg}`;
    },
    getFormattedSecondImage(mainImg, defaultImg) {
      return mainImg && mainImg.length ? `${mainImg[1]}` : `${defaultImg}`;
    },
    getFormattedThirdImage(mainImg, defaultImg) {
      return mainImg && mainImg.length ? `${mainImg[2]}` : `${defaultImg}`;
    },
  },
};
</script>
